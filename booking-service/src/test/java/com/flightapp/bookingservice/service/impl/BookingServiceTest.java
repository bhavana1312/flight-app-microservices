...
class BookingServiceImplTest {
    ...
    void testGetTicketJsonNotFound() {
        ...
        assertThrows(BookingException.class, () ->
                service.getTicketJson("X"));
    }

    @Test
    void testCancelBookingSuccess() {
        Booking b = new Booking(
                1L, "PNR123", "abc@gmail.com",
                "John:M:20", 2, 10L,
                LocalDateTime.now(), "BOOKED",
                5000.0, "json",
    ...
    void testCancelBookingOnlyBookedAllowed() {
        ...
        assertThrows(BookingException.class, () ->
                service.cancelBooking("P"));
    }

    @Test
    void testDownloadTicketSuccess() {
        Booking b = new Booking(
                1L, "PNR1", "abc@gmail.com",
                "A", 1, 10L,
                LocalDateTime.now(), "BOOKED",
                1000.0, "{}",
