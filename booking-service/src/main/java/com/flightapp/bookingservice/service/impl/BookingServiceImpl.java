...
public class BookingServiceImpl implements BookingService {
    ...
    public Booking bookTicket(Long flightId, BookingRequest req) {
        ...
        String ticketJson = String.format(
            "{\"pnr\":\"%s\",\"flightId\":%d,\"journeyDate\":\"%s\",\"passengers\":\"%s\"}",
            booking.getPnr(), flightId, req.getJourneyDate().toString(), req.getPassengerDetails());
    ...
    public String getTicketJson(String pnr) {
        ...
        if (b == null) throw new RuntimeException("PNR not found");
